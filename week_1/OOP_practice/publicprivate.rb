...
person.implicitly_speak # => I am a protected method
# person.cry # => private method `cry' called for #<Human:0x007f8f298de248> (NoMethodError)
# person.explicitly_cry # => `explicitily_cry': private method `cry' called for #<Human:0x007f87a30bf450> (NoMethodError)
